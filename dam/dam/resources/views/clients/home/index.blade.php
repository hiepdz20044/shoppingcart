                        ...
                        <div class="container-fluid">
                            <div class="hero__slider--items__inner hero__slider--bg2__inner">
                                <div class="slider__content">
                                    ...
                                    <h2 class="slider__content--maintitle h1">New Collection <br>
                                        Summer Sale</h2>
                                    <p class="slider__content--desc desc2 d-sm-2-none mb-40">Lorem ipsum dolor sit amet,
                                        consectetur adipisicing elit, sed do <br> eiusmod tempor incididunt ut labore et
                                        dolore magna</p>
            ...
            <div class="row mb--n28">
                <div class="col-lg-4 col-md-order mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="shop.html"><img class="banner__items--thumbnail__img"
                                src="{{ asset('assets/clients/img/banner/banner7.png') }}" alt="banner-img">
                    ...
                    <div class="banner__style2--top__sidebar d-flex">
                        <div class="banner__items position__relative mr-30 mb-28">
                            <a class="banner__items--thumbnail" href="shop.html"><img
                                    ...
                                    src="{{ asset('assets/clients/img/banner/banner8.png') }}" alt="banner-img">
                                <div class="banner__items--content style2">
                                    <h3 class="banner__items--content__title style2">NEW <br>
                                        ACCESSORIES</h3>
                                    <span class="banner__items--content__link style2">SHOP NOW</span>
                        ...
                        <div class="banner__items position__relative mb-28">
                            <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img"
                                    src="{{ asset('assets/clients/img/banner/banner9.png') }}" alt="banner-img">
                                <div class="banner__items--content style2">
                    ...
                    <div class="row row-cols-sm-2 row-cols-1">
                        <div class="col mb-28">
                            <div class="banner__items position__relative">
                                <a class="banner__items--thumbnail" href="shop.html"><img
                                        class="banner__items--thumbnail__img banner__img--max__height"
                                        src="{{ asset('assets/clients/img/banner/banner10.png') }}" alt="banner-img">
                                    <div class="banner__items--content style2">
                        ...
                        <div class="col mb-28">
                            <div class="banner__items position__relative">
                                <a class="banner__items--thumbnail" href="shop.html"><img
                                        class="banner__items--thumbnail__img banner__img--max__height"
                                        src="{{ asset('assets/clients/img/banner/banner11.png') }}" alt="banner-img">
                        ...
                        <div class="col mb-30">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="{{ route('details', ['id' => $item->id]) }}">
                                        <img class="product__items--img product__primary--img"
                                            style="width: 282px; height: 310px;"
                                            src="{{ url('storage/', $item->hinh_anh) }}" alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ url('storage/', $item->id) }}" alt="product-img">
                                    </a>
                                    ...
                                    <ul class="product__items--action__style2">
                                        <li class="product__items--action__style2--list">
                                            <a class="product__items--action__style2--btn" href="wishlist.html">
                                                <svg class="product__items--action__btn--svg"
                                                    xmlns="http://www.w3.org/2000/svg" width="23.51" height="21.443"
                                                    viewBox="0 0 512 512">
                                                    <path
                                        ...
                                        <li class="product__items--action__style2--list">
                                            <a class="product__items--action__style2--btn" data-open="modal1"
                                ...
                                <div class="product__items--content text-center">
                                    <span class="product__items--content__subtitle">{{ $item->ma_san_pham }}</span>
                                    <h3 class="product__items--content__title h4"><a
                                            href="product-details.html">{{ $item->ten_san_pham }}</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">{{ $item->gia_khuyen_mai }} VND</span>
                                        <span class="price__divided"></span>
                                        <span class="old__price">{{ $item->gia }} VDN</span>
                                    </div>
                    ...
                    <div class="col">
                        <div class="banner__items banner__discount--items position__relative">
                            <a class="banner__items--thumbnail " href="shop.html"><img
                                    ...
                                    src="{{ asset('assets/clients/img/banner/banner12.png') }}" alt="banner-img"></a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="banner__items banner__discount--items position__relative">
                            <a class="banner__items--thumbnail " href="shop.html"><img
                                    class="banner__items--thumbnail__img"
                                    src="{{ asset('assets/clients/img/banner/banner13.png') }}" alt="banner-img"></a>
                        </div>
                    </div>
                </div>
    ...
    <section class="product__section section--padding color-scheme-2 pt-0">
        <div class="container-fluid">
            <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n30">
                <div class="col mb-30">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail width-100 " href="shop.html"><img
                                class="banner__items--thumbnail__img width-100"
                                src="{{ asset('assets/clients/img/banner/banner14.png') }}" alt="banner-img">
                        ...
                        <div class="product__grid--inner">
                            <div class="product__items product__items--grid d-flex align-items-center">
                                <div class="product__items--grid__thumbnail position__relative">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('assets/clients/img/product/small-product1.png') }}"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('assets/clients/img/product/small-product2.png') }}"
                                            alt="product-img">
                                    </a>
                                </div>
                                <div class="product__items--grid__content">
                                    <h3 class="product__items--content__title h4"><a href="product-details.html">Women
                                            Fish Cut Cloth</a></h3>
                                    <div class="product__items--price">
                            ...
                            <div class="product__items product__items--grid d-flex align-items-center">
                                <div class="product__items--grid__thumbnail position__relative">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('assets/clients/img/product/small-product3.png') }}"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('assets/clients/img/product/small-product4.png') }}"
                                            alt="product-img">
                                    </a>
                                </div>
                                <div class="product__items--grid__content">
                                    <h3 class="product__items--content__title h4"><a href="product-details.html">Gorgeous
                                            Granite Clock</a></h3>
                                    <div class="product__items--price">
                            ...
                            <div class="product__items product__items--grid d-flex align-items-center">
                                <div class="product__items--grid__thumbnail position__relative">
                                    <a class="product__items--link" href="product-details.html">
                                        <img class="product__items--img product__primary--img"
                                            src="{{ asset('assets/clients/img/product/small-product5.png') }}"
                                            alt="product-img">
                                        <img class="product__items--img product__secondary--img"
                                            src="{{ asset('assets/clients/img/product/small-product6.png') }}"
                                            alt="product-img">
                                    </a>
                                </div>
                                <div class="product__items--grid__content">
                                    <h3 class="product__items--content__title h4"><a href="product-details.html">Durable
                                            Steel Knife</a></h3>
                                    <div class="product__items--price">
                ...
                <div class="col mb-30">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail md-width-100" href="shop.html"><img
                                class="banner__items--thumbnail__img md-width-100"
                                src="{{ asset('assets/clients/img/banner/banner15.png') }}" alt="banner-img">
                            <div class="banner__items--content__style3">
                                <span class="banner__items--content__style3--subtitle text-white">Wmen's Collection</span>
                                <h2 class="banner__items--content__style3--title text-white h3"> Min.40-70% Off</h2>
                            </div>
                    ...
                    <div class="product__grid--wrapper">
                        ...
                        <div class="product__grid--inner">
                            ...
                            <div class="product__items product__items--grid d-flex align-items-center">
                                ...
                                <div class="product__items--grid__content">
                                    <h3 class="product__items--content__title h4"><a href="product-details.html">Smart
                                            Blazar for Men</a></h3>
                                    <div class="product__items--price">
                                        <span class="current__price">$160</span>
                                        <span class="price__divided"></span>
                    ...
                    <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block"
                                src="{{ asset('assets/clients/img/logo/brand-logo1.png') }}" alt="brand logo img">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block"
                                src="{{ asset('assets/clients/img/logo/brand-logo2.png') }}" alt="brand logo img">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block"
                                src="{{ asset('assets/clients/img/logo/brand-logo3.png') }}" alt="brand logo img">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block"
                                src="{{ asset('assets/clients/img/logo/brand-logo4.png') }}" alt="brand logo img">
                        </div>
                        <div class="brand__logo--items">
                            <img class="brand__logo--items__thumbnail--img display-block"
                                src="{{ asset('assets/clients/img/logo/brand-logo5.png') }}" alt="brand logo img">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col col-sm-order">
                        <div class="shop__card--content">
                            ...
                            <h2 class="shop__card--content__maintitle mb-12">Support your <br>
                                neighborhood</h2>
                            <p class="shop__card--content__desc">We believe that local businesses are an integral <br>
                                part of a neighborhood's character. Help keep <br> local by buying a gift card!</p>
                            <a class="shop__card--content__btn bg__secondary2 primary__btn" href="shop.html">Shop gift
                                cards</a>
                        </div>
                    </div>
                    <div class="col">
                        <div class="shop__card--banner position__relative d-flex">
                            <div class="shop__card--banner__thumbnail one">
                                <a class="display-block" href="shop.html"><img
                                        class="shop__card--banner__thumbnail--img display-block"
                                        src="{{ asset('assets/clients/img/banner/banner16.png') }}"
                                        alt="shop-card-banner"></a>
                            </div>
                            <div class="shop__card--banner__thumbnail two">
                                <a class="display-block" href="shop.html"><img
                                        class="shop__card--banner__thumbnail--img display-block"
                                        src="{{ asset('assets/clients/img/banner/banner17.png') }}"
                                        alt="shop-card-banner"></a>
                            </div>
                            <div class="shop__card--play banner__bideo--play">
                                <a class="shop__card--play__icon banner__bideo--play__icon glightbox"
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="testimonial__items--style2 testimonial__items text-center">
                            <div class="testimonial__items--style2__thumbnail mb-10">
                                <img class="testimonial__items--style2__thumbnail--img border-radius-50"
                                    src="{{ asset('assets/clients/img/other/testimonial-thumb1.png') }}"
                                    alt="testimonial-img">
                            </div>
                            <div class="testimonial__items--content">
                                ...
                                <p class="testimonial__items--desc style2 text-white">Lorem ipsum dolor sit amet,
                                    consectetur adipisicin elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial__items--style2 testimonial__items text-center">
                            <div class="testimonial__items--style2__thumbnail mb-10">
                                <img class="testimonial__items--style2__thumbnail--img border-radius-50"
                                    src="{{ asset('assets/clients/img/other/testimonial-thumb2.png') }}"
                                    alt="testimonial-img">
                            </div>
                            <div class="testimonial__items--content">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial__items--style2 testimonial__items text-center">
                            <div class="testimonial__items--style2__thumbnail mb-10">
                                <img class="testimonial__items--style2__thumbnail--img border-radius-50"
                                    src="{{ asset('assets/clients/img/other/testimonial-thumb3.png') }}"
                                    alt="testimonial-img">
                            </div>
                            <div class="testimonial__items--content">
                                <h2 class="testimonial__items--title text-white h3">Nike Mardson</h2>
                        ...
                        <div class="home__contact--info">
                            ...
                            <div class="home__contact--info__items d-flex">
                                ...
                                <div class="contact__info--content">
                                    ...
                                    <p class="contact__info--content__desc"><a href="tel:+01234-567890">+01234-567890</a>
                                        <br> <a href="tel:++01234-5688765">+01234-5688765</a>
                                    </p>
                                </div>
                            </div>
                            <div class="home__contact--info__items d-flex">
                                ...
                                <div class="contact__info--content">
                                    ...
                                    <p class="contact__info--content__desc"> <a
                    ...
                    <div class="col-lg-7 col-md-7">
                        <div class="home__contact--map">
                            <iframe
                                ...
                                width="600" height="380" style="border:0;" allowfullscreen=""
                                loading="lazy"></iframe>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link" href="blog-details.html"><img
                                        ...
                                        src="{{ asset('assets/clients/img/blog/blog1.png') }}" alt="blog-img"></a>
                            </div>
                            <div class="blog__content style2">
                                <span class="blog__content--meta">February 03, 2022</span>
                                <h3 class="blog__content--title style2"><a href="blog-details.html">Fashion Trends In
                                        2021 Styles,
                                        Colors, Accessories</a></h3>
                                <a class="blog__content--btn style2 primary__btn" href="blog-details.html">Read more
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link" href="blog-details.html"><img
                                        class="blog__thumbnail--img"
                                        src="{{ asset('assets/clients/img/blog/blog2.png') }}" alt="blog-img"></a>
                            </div>
                            <div class="blog__content style2">
                                <span class="blog__content--meta">February 03, 2022</span>
                                <h3 class="blog__content--title style2"><a href="blog-details.html">Meet the Woman
                                        Behind Cool
                    ...
                    <div class="swiper-slide">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link" href="blog-details.html"><img
                                        class="blog__thumbnail--img"
                                        src="{{ asset('assets/clients/img/blog/blog3.png') }}" alt="blog-img"></a>
                            </div>
                            <div class="blog__content style2">
                                <span class="blog__content--meta">February 03, 2022</span>
                                <h3 class="blog__content--title style2"><a href="blog-details.html">Lauryn Hill Could
                                        Make Tulle
                    ...
                    <div class="swiper-slide">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link" href="blog-details.html"><img
                                        class="blog__thumbnail--img"
                                        src="{{ asset('assets/clients/img/blog/blog4.png') }}" alt="blog-img"></a>
                            </div>
                            <div class="blog__content style2">
                                <span class="blog__content--meta">February 03, 2022</span>
                                <h3 class="blog__content--title style2"><a href="blog-details.html">Fashion Trends In
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block"
                        src="{{ asset('assets/clients/img/banner/newsletter-popup-thumb.png') }}"
                ...
                <div class="row row-cols-lg-2 row-cols-md-2">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/clients/img/product/small-product7.png') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/clients/img/product/small-product8.png') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/clients/img/product/small-product9.png') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/clients/img/product/small-product10.png') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/clients/img/product/small-product11.png') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img"
                                                src="{{ asset('assets/clients/img/product/small-product12.png') }}"
                                                alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col">
                        <div class="quickview__info">
                            <form action="#">
                                <h2 class="product__details--info__title mb-15">{{ $item->ten_san_pham }}</h2>
                                <div class="product__details--info__price mb-10">
                                    <span class="current__price">{{ $item->gia }}VND</span>
                                    <span class="old__price">{{ $item->gia_khuyen_mai }}</span>
                                </div>

                                <p class="product__details--info__desc mb-15">{{ $item->mo_ta_ngan }}</p>
