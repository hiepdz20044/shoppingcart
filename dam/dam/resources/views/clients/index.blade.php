       ...
       <div class="row mb--n28">
           <div class="col-lg-4 col-md-order mb-28">
               <div class="banner__items position__relative">
                   <a class="banner__items--thumbnail " href="shop.html"><img class="banner__items--thumbnail__img" src="{{ asset('assets/clients/img/banner/banner7.png') }}" alt="banner-img">
           ...
           <div class="col-lg-8">
               <div class="banner__style2--top__sidebar d-flex">
                   <div class="banner__items position__relative mr-30 mb-28">
                       <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{ asset('assets/clients/img/banner/banner8.png') }}" alt="banner-img">
                           <div class="banner__items--content style2">
                               <h3 class="banner__items--content__title style2">NEW <br>
                                   ACCESSORIES</h3>
                               <span class="banner__items--content__link style2">SHOP NOW</span>
                   ...
                   <div class="banner__items position__relative mb-28">
                       <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img" src="{{ asset('assets/clients/img/banner/banner9.png') }}" alt="banner-img"> 
                           <div class="banner__items--content style2">
               ...
               <div class="row row-cols-sm-2 row-cols-1">
                   <div class="col mb-28">
                       <div class="banner__items position__relative">
                           <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{ asset('assets/clients/img/banner/banner10.png') }}" alt="banner-img"> 
                               <div class="banner__items--content style2">
                   ...
                   <div class="col mb-28">
                       <div class="banner__items position__relative">
                           <a class="banner__items--thumbnail" href="shop.html"><img class="banner__items--thumbnail__img banner__img--max__height" src="{{ asset('assets/clients/img/banner/banner11.png') }}" alt="banner-img"> 
           ...
           <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                   ...
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product1.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product2.png') }}" alt="product-img">
                           </a>
               ...
               <div class="col mb-30">
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product3.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product4.png') }}" alt="product-img">
                           </a>
                           <div class="product__badge">
                               <span class="product__badge--items sale">Sale</span>
                           </div>
               ...
               <div class="col mb-30">
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product5.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product6.png') }}" alt="product-img">
                           </a>
                           <div class="product__badge">
                               <span class="product__badge--items sale">Sale</span>
                           </div>
               ...
               <div class="col mb-30">
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product7.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product8.png') }}" alt="product-img">
                           </a>
                           <div class="product__badge">
                               <span class="product__badge--items sale">Sale</span>
                           </div>
               ...
               <div class="col mb-30">
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product9.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product10.png') }}" alt="product-img">
                           </a>
                           <div class="product__badge">
                               <span class="product__badge--items sale">Sale</span>
                           </div>
               ...
               <div class="col mb-30">
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product11.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product12.png') }}" alt="product-img">
                           </a>
                           <div class="product__badge">
                               <span class="product__badge--items sale">Sale</span>
                           </div>
               ...
               <div class="col mb-30">
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product13.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product14.png') }}" alt="product-img">
                           </a>
                           <div class="product__badge">
                               <span class="product__badge--items sale">Sale</span>
                           </div>
               ...
               <div class="col mb-30">
                   <div class="product__items ">
                       <div class="product__items--thumbnail">
                           <a class="product__items--link" href="product-details.html">
                               <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/product2.png') }}" alt="product-img">
                               <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/product1.png') }}" alt="product-img">
                           </a>
                           <div class="product__badge">
                               <span class="product__badge--items sale">Sale</span>
                           </div>
           ...
           <div class="row row-cols-sm-2 row-cols-1">
               <div class="col">
                   <div class="banner__items banner__discount--items position__relative">
                       <a class="banner__items--thumbnail " href="shop.html"><img class="banner__items--thumbnail__img" src="{{ asset('assets/clients/img/banner/banner12.png') }}" alt="banner-img"></a>
                   </div>
               </div>
               <div class="col">
                   <div class="banner__items banner__discount--items position__relative">
                       <a class="banner__items--thumbnail " href="shop.html"><img class="banner__items--thumbnail__img" src="{{ asset('assets/clients/img/banner/banner13.png') }}" alt="banner-img"></a>
                   </div>
               </div>
           </div>
...
<section class="product__section section--padding color-scheme-2 pt-0">
   <div class="container-fluid">
       <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n30">
           <div class="col mb-30">
               <div class="banner__items position__relative">
                   <a class="banner__items--thumbnail width-100 " href="shop.html"><img class="banner__items--thumbnail__img width-100" src="{{ asset('assets/clients/img/banner/banner14.png') }}" alt="banner-img">
                   ...
                   <div class="product__grid--inner">
                       <div class="product__items product__items--grid d-flex align-items-center">
                           <div class="product__items--grid__thumbnail position__relative">
                               <a class="product__items--link" href="product-details.html">
                                   <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/small-product1.png') }}" alt="product-img">
                                   <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/small-product2.png') }}" alt="product-img">
                               </a>
                           </div>
                       ...
                       <div class="product__items product__items--grid d-flex align-items-center">
                           <div class="product__items--grid__thumbnail position__relative">
                               <a class="product__items--link" href="product-details.html">
                                   <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/small-product3.png') }}" alt="product-img">
                                   <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/small-product4.png') }}" alt="product-img">
                               </a>
                           </div>
                           <div class="product__items--grid__content">
                       ...
                       <div class="product__items product__items--grid d-flex align-items-center">
                           <div class="product__items--grid__thumbnail position__relative">
                               <a class="product__items--link" href="product-details.html">
                                   <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/small-product5.png') }}" alt="product-img">
                                   <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/small-product6.png') }}" alt="product-img">
                               </a>
                           </div>
                           <div class="product__items--grid__content">
           ...
           <div class="col mb-30">
               <div class="banner__items position__relative">
                   <a class="banner__items--thumbnail md-width-100" href="shop.html"><img class="banner__items--thumbnail__img md-width-100" src="{{ asset('assets/clients/img/banner/banner15.png') }}" alt="banner-img">
                       <div class="banner__items--content__style3">
                           <span class="banner__items--content__style3--subtitle text-white">Wmen's Collection</span>
                           <h2 class="banner__items--content__style3--title text-white h3"> Min.40-70% Off</h2>
                       </div>
               ...
               <div class="product__grid--wrapper">
                   ...
                   <div class="product__grid--inner">
                       <div class="product__items product__items--grid d-flex align-items-center">
                           <div class="product__items--grid__thumbnail position__relative">
                               <a class="product__items--link" href="product-details.html">
                                   <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/small-product2.png') }}" alt="product-img">
                                   <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/small-product1.png') }}" alt="product-img">
                               </a>
                           </div>
                           <div class="product__items--grid__content">
                       ...
                       <div class="product__items product__items--grid d-flex align-items-center">
                           <div class="product__items--grid__thumbnail position__relative">
                               <a class="product__items--link" href="product-details.html">
                                   <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/small-product4.png') }}" alt="product-img">
                                   <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/small-product3.png') }}" alt="product-img">
                               </a>
                           </div>
                           <div class="product__items--grid__content">
                       ...
                       <div class="product__items product__items--grid d-flex align-items-center">
                           <div class="product__items--grid__thumbnail position__relative">
                               <a class="product__items--link" href="product-details.html">
                                   <img class="product__items--img product__primary--img" src="{{ asset('assets/clients/img/product/small-product6.png') }}" alt="product-img">
                                   <img class="product__items--img product__secondary--img" src="{{ asset('assets/clients/img/product/small-product5.png') }}" alt="product-img">
                               </a>
                           </div>
                           <div class="product__items--grid__content">
           ...
           <div class="col">
               <div class="brand__logo--section__inner d-flex justify-content-center align-items-center">
                   <div class="brand__logo--items">
                       <img class="brand__logo--items__thumbnail--img display-block" src="{{ asset('assets/clients/img/logo/brand-logo1.png') }}" alt="brand logo img">
                   </div>
                   <div class="brand__logo--items">
                       <img class="brand__logo--items__thumbnail--img display-block" src="{{ asset('assets/clients/img/logo/brand-logo2.png') }}" alt="brand logo img">
                   </div>
                   <div class="brand__logo--items">
                       <img class="brand__logo--items__thumbnail--img display-block" src="{{ asset('assets/clients/img/logo/brand-logo3.png') }}" alt="brand logo img">
                   </div>
                   <div class="brand__logo--items">
                       <img class="brand__logo--items__thumbnail--img display-block" src="{{ asset('assets/clients/img/logo/brand-logo4.png') }}" alt="brand logo img">
                   </div>
                   <div class="brand__logo--items">
                       <img class="brand__logo--items__thumbnail--img display-block" src="{{ asset('assets/clients/img/logo/brand-logo5.png') }}" alt="brand logo img">
                   </div>
               </div>
           </div>
       </div>
               ...
               <div class="col">
                   <div class="shop__card--banner position__relative d-flex">
                       <div class="shop__card--banner__thumbnail one">
                           <a class="display-block" href="shop.html"><img class="shop__card--banner__thumbnail--img display-block" src="{{ asset('assets/clients/img/banner/banner16.png') }}" alt="shop-card-banner"></a>
                       </div>
                       <div class="shop__card--banner__thumbnail two">
                           <a class="display-block" href="shop.html"><img class="shop__card--banner__thumbnail--img display-block" src="{{ asset('assets/clients/img/banner/banner17.png') }}" alt="shop-card-banner"></a>
                       </div>
       ...
       <div class="testimonial__bg--inner testimonial__activation--column1 swiper">
           <div class="swiper-wrapper">
               <div class="swiper-slide">
                   <div class="testimonial__items--style2 testimonial__items text-center">
                       <div class="testimonial__items--style2__thumbnail mb-10">
                           <img class="testimonial__items--style2__thumbnail--img border-radius-50" src="{{ asset('assets/clients/img/other/testimonial-thumb1.png') }}" alt="testimonial-img">
                       </div>
               ...
               <div class="swiper-slide">
                   <div class="testimonial__items--style2 testimonial__items text-center">
                       <div class="testimonial__items--style2__thumbnail mb-10">
                           <img class="testimonial__items--style2__thumbnail--img border-radius-50" src="{{ asset('assets/clients/img/other/testimonial-thumb2.png') }}" alt="testimonial-img">
                       </div>
                       <div class="testimonial__items--content">
               ...
               <div class="swiper-slide">
                   <div class="testimonial__items--style2 testimonial__items text-center">
                       <div class="testimonial__items--style2__thumbnail mb-10">
                           <img class="testimonial__items--style2__thumbnail--img border-radius-50" src="{{ asset('assets/clients/img/other/testimonial-thumb3.png') }}" alt="testimonial-img">
                       </div>
                       <div class="testimonial__items--content">
                           <h2 class="testimonial__items--title text-white h3">Nike Mardson</h2>
                           <span class="testimonial__items--subtitle text-white">fashion</span>
       ...
       <div class="blog__section--inner blog__swiper--activation swiper">
           <div class="swiper-wrapper">
               <div class="swiper-slide">
                   <div class="blog__items">
                       <div class="blog__thumbnail">
                           <a class="blog__thumbnail--link" href="blog-details.html"><img class="blog__thumbnail--img" src="{{ asset('assets/clients/img/blog/blog1.png') }}" alt="blog-img"></a>
                       </div>
               ...
               <div class="swiper-slide">
                   <div class="blog__items">
                       <div class="blog__thumbnail">
                           <a class="blog__thumbnail--link" href="blog-details.html"><img class="blog__thumbnail--img" src="{{ asset('assets/clients/img/blog/blog2.png') }}" alt="blog-img"></a>
                       </div>
                       <div class="blog__content style2">
                           <span class="blog__content--meta">February 03, 2022</span>
               ...
               <div class="swiper-slide">
                   <div class="blog__items">
                       <div class="blog__thumbnail">
                           <a class="blog__thumbnail--link" href="blog-details.html"><img class="blog__thumbnail--img" src="{{ asset('assets/clients/img/blog/blog3.png') }}" alt="blog-img"></a>
                       </div>
                       <div class="blog__content style2">
                           <span class="blog__content--meta">February 03, 2022</span>
               ...
               <div class="swiper-slide">
                   <div class="blog__items">
                       <div class="blog__thumbnail">
                           <a class="blog__thumbnail--link" href="blog-details.html"><img class="blog__thumbnail--img" src="{{ asset('assets/clients/img/blog/blog4.png') }}" alt="blog-img"></a>
                       </div>
                       <div class="blog__content style2">
                           <span class="blog__content--meta">February 03, 2022</span>
                           <h3 class="blog__content--title style2"><a href="blog-details.html">Fashion Trends In 2021 Styles,
