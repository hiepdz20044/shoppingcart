                        ...
                        <div class="col-lg-8">
                            <div class="cart__table">
                                ...
                                <div class="continue__shopping d-flex justify-content-between">
                                    <a class="color-scheme-2 continue__shopping--link" href="shop.html">Continue
                                        shopping</a>
                                    <button class="color-scheme-2 continue__shopping--clear" type="submit">Clear
                                        Cart</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="cart__summary border-radius-10">
                                ...
                                <div class="cart__summary--footer">
                                    ...
                                    <ul class="d-flex justify-content-between">
                                        <li><button class="color-scheme-2 cart__summary--footer__btn primary__btn cart"
                                                type="submit">Update Cart</button></li>
                                        <li><a class="color-scheme-2 cart__summary--footer__btn primary__btn checkout"
